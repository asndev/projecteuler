...
public class problem17 {
    ...
    public static int tripleDigit(int n) {
        ...
        int a = Integer.parseInt(numb.charAt(0) + "");
        int b = Integer.parseInt(numb.charAt(1) + "");
        int c = Integer.parseInt(numb.charAt(2) + "");
        int bc = (b == 0) ? c : Integer.parseInt(numb.charAt(1) + "" + numb.charAt(2));
        int pwnd = (b == 0) ? singleDigit(c) : doubleDigit(bc);
    ...
    public static int doubleDigit(int n) {
        ...
        int a = Integer.parseInt(number.charAt(0) + "");
        int b = Integer.parseInt(number.charAt(1) + "");
